...
const MainEmpty = resolve => require(['components/basetemp/MainEmpty'], resolve)
...
const ContractMaterialList = resolve => require(['view/goods/ContractMaterialList'], resolve)
const PurchaseReconciliationList = resolve => require(['view/goods/PurchaseReconciliationList'], resolve)
const SaleReconciliationList = resolve => require(['view/goods/SaleReconciliationList'], resolve)
...
const ExternalDetails = resolve => require(['view/order/ExternalDetails'], resolve)
...
const AddGoodsSupplierSettlement = resolve => require(['view/finance/AddGoodsSupplierSettlement'], resolve)
const AddGoodsProjectSettlement = resolve => require(['view/finance/AddGoodsProjectSettlement'], resolve)
...
const EditBeamSettlement = resolve => require(['view/finance/EditBeamSettlement'], resolve)
...
const OrderNewDetail = resolve => require(['view/sales/ordermanager/OrderNewDetail'], resolve)
...
const ReturnGoodDetails = resolve => require(['view/sales/returnGood/ReturnGoodDetails'], resolve)
const ExchangeGoodDetails = resolve => require(['view/sales/returnGood/ExchangeGoodDetails'], resolve)
const PlannedTransferOrder = resolve => require(['view/sales/PlannedTransferOrder'], resolve)
const PlannedTransferOrderDetails = resolve => require(['view/sales/PlannedTransferOrderDetails'], resolve)
...
const PurPackListElse = resolve => require(['view/procurement/PurPackListElse'], resolve)
...
const ProcurementStayStockList = resolve => require(['view/procurement/StayStockList'], resolve)
...
const SalesDetailBoard = resolve => require(['view/board/SalesDetailBoard'], resolve)
...
const ProfitDetailsElse = resolve => require(['view/board/ProfitDetailsElse'], resolve) // 经营看板=>月份排名
const PurchasePerformanceDetails = resolve => require(['view/board/PurchaseDetails'], resolve) // 经营看板=>采购员绩效详情
const SupplychainPerformanceDetails = resolve => require(['view/board/ChainDetails'], resolve) // 经营看板=>供应链绩效详情
const SupplierPerformanceDetails = resolve => require(['view/board/SupplierDetails'], resolve) // 经营看板=>供应商绩效详情
const ProfitGoodsDetails = resolve => require(['view/board/ProfitGoodsDetails'], resolve) // 经营看板=>经营概况=>物资明细
...
const BatchReceiptDetails = resolve => require(['view/batchReceipt/Details'], resolve)

// 审批事项
const SupplyChainExamine = resolve => require(['view/examine/SupplyChain'], resolve) // 供应链部
const ProductDataExamine = resolve => require(['view/examine/ProductData'], resolve) // 产品数据部
...
const FinanceExport = resolve => require(['view/examine/FinanceExport'], resolve) // 财务部导出
...
const MaterialModifyList = resolve => require(['view/statistics/MaterialModifyList'], resolve) // 物资修改记录
const SupplierPurchaseList = resolve => require(['view/statistics/SupplierPurchaseList'], resolve) // 供应商采购记录
const MaterialApprovalStatus = resolve => require(['view/statistics/MaterialApprovalStatus'], resolve) // 物资审批状态

// 平台结算管理 platformSettlement
const PlatformSettlementList = resolve => require(['view/platformSettlement/List'], resolve) // 平台结算管理
const SupplierSettlement = resolve => require(['view/platformSettlement/SupplierSettlement'], resolve) // 供应商结算
const SupplierSettlementDetails = resolve => require(['view/platformSettlement/SupplierSettlementDetails'], resolve) // 供应商结算详情
const ProjectSettlement = resolve => require(['view/platformSettlement/ProjectSettlement'], resolve) // 梁场结算
const ProjectSettlementDetails = resolve => require(['view/platformSettlement/ProjectSettlementDetails'], resolve) // 梁场结算详情
    ...
    children: [{
      ...
      children: [{
        ...
        children: [{
          ...
          path: 'addGoodsProjectSettlement/:projectId/:settlementId/:invoiceId',
      ...
      children: [{
        ...
        children: [{
          ...
          path: 'addGoodsSupplierSettlement/:projectId/:settlementId/:winSupplierId/:settlementType',
