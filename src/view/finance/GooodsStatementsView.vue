    ...
    data () {
      return {
        ...
        invoiceHeader: [
          ...
          {label: '税号', prop: 'purchasingBillInvoiceTaxpayCode'},
          {label: '单位地址', prop: 'purchasingBillInvoiceReceiverAddress'},
          {label: '单位电话', prop: 'purchasingBillInvoiceRegistryPhone'},
          {label: '开户银行', prop: 'purchasingBillInvoiceOpenAccount'},
          {label: '开户行', prop: ''},
          {label: '银行账号', prop: ''},
          {label: '收票人', prop: 'purchasingBillInvoiceReceiverName'},
