<template>
  <div>
    ...
    <table-list :data-header="TableDataHeader" :url="urlSupplier"
  ...
  export default {
    data () {
      return {
        ...
        urlSupplierBar: this.$Api.platformSettlement.gysSettlementHistogram,
        settTotalCostArr: [],
        totalCostArr: [],
        searchData: [
        ...
        page: {
          ...
          isProject: 1,
          dataSource: 2,
          refs: 'tab_supplier_settlement_list'
        },
        tablePerformance: 'tab_supplier_settlement_list'
      }
    },
    created () {
      let date = new Date()
