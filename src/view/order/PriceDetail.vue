<template>
    <div>
      ...
      <div class="title" style="margin-top: 15px;">商品明细</div>
        <table-list :data-header="dataHeader" :data-static="dataStatic" :refs="tablePerformance" :static="tableStatic" @get-table-data="getTableData">
        ...
        <br>
        <div class="title" style="margin-top: 10px;">审批记录</div>
  ...
  export default {
    data () {
      return {
        ...
        approvalPage: {id: 0},
        approvalRef: 'price_approval_table',
        id: '', // purcharId
        data: [
