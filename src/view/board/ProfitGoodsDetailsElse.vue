...
<script>
  export default {
    ...
    methods: {
      onExport () {
        let str = ''
        if (this.page.projectId) {
          str += '?projectId=' + this.page.projectId
        } else {
          str += '?projectId='
        }
        if (this.dataSearch.goodsName) {
          str += '&goodsName=' + this.dataSearch.goodsName
        } else {
          str += ''
        }
        ...
        location.href = this.$Api.board.exportGoodsDetail + str
      },
      getTableData (data) {
