  ...
  <div>
    <div class="box_board">
      ...
      <div class="box_profit">
        <div id="chart_Profit" class="chart_Profit" :style="{width: '390px', height: '340px'}"></div>
        <!-- <div class="box_ul">
  ...
  export default {
    data () {
      return {
        ...
        urlMaterialRank: this.$Api.wisdomBeam.materialRank  // 可视化看板=>利润率排名
      }
    },
    created () {
      this.getBeamField()
    ...
    methods: {
      ...
      getDateAndMonth () {
        ...
        console.log(this.startTimeMonth, this.endTimeMonth)
        return temp
      },
      /**
       * 获取当前梁场 所有数据
...
<style scoped>
  .box_board {
    ...
    padding-top: 20px;
    background-image: url(../../static/img/wisdomBeam/2.jpg);
    position: relative;
  }
